...
*/}}
{{- define "ntn-operators.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "ntn-operators.resourceName" -}}
{{- $fullname := include "ntn-operators.fullname" .context }}
{{- $suffix := .suffix }}
