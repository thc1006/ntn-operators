...
**已確認的 Issues**：
- [GitHub #1066](https://github.com/srsran/srsRAN_Project/issues/1066 (archived repo))（2025-02）：SIB19 ephemeris 不更新
- [GitHub #1293](https://github.com/srsran/srsRAN_Project/issues/1293 (archived repo))：額外 SIB19 問題
...
**來源**：
1. [GitHub Issue #1066](https://github.com/srsran/srsRAN_Project/issues/1066 (archived repo))
2. [GitHub Issue #1293](https://github.com/srsran/srsRAN_Project/issues/1293 (archived repo))
